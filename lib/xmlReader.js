...
const TESTOMATIO_URL = config.TESTOMATIO_URL || "https://app.testomat.io";
const { TESTOMATIO_RUNGROUP_TITLE, TESTOMATIO_TITLE, TESTOMATIO_ENV, TESTOMATIO_RUN, TESTOMATIO } = config;
