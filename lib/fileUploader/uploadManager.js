...
const handleFileUploadByPath = async (runId, filepath) => {
    ...
    const isAzureEnabled = AzureUploader.isAzureArtifactsEnabled();
    // Check if S3 variables are defined
    const isS3Enabled =  S3Uploader.isS3ArtifactsEnabled();
...
module.exports = {
    ...
    isArtifactsS3Enabled: memoize(S3Uploader.isS3ArtifactsEnabled()),
    isArtifactsAzureEnabled: memoize(AzureUploader.isAzureArtifactsEnabled())
};
