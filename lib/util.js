 ...
 */
export const parseTest = testTitle => {
 ...
 */
export const parseSuite = suiteTitle => {
...
export const fetchSourceCode = (contents, opts = {}) => {
...
export const isSameTest = (test, t) => (typeof t === 'object') 
    && (typeof test === 'object') 
    && t.title === test.title 
 ...
 */
export const specificTestInfo = test => {
