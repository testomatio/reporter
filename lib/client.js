...
// 2. got error "__dirname already defined" in compiles js code (lib-cjs) 
...
class Client {
   ...
   */
  constructor(params = {}) {
    console.log(pc.blue(` >>>>>>> CLIENT CONSTRUCTOR CALLED`));
    this.uuid = randomUUID();
    this.queue = Promise.resolve();
    this.totalUploaded = 0;
    this.failedToUpload = 0;

    const pathToPackageJSON = path.join(process.cwd(), 'node_modules', '@testomatio/reporter', 'package.json');
    try {
