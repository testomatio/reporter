...
if (config.TESTOMATIO_RUN) {
  process.env.runId = config.TESTOMATIO_RUN;
}
...
class TestomatioPipe {
  constructor(params, store) {
    ...
    this.url = params.testomatioUrl || config.TESTOMATIO_URL || 'https://app.testomat.io';
    ...
    this.store = store || {};
    this.title = params.title || config.TESTOMATIO_TITLE;
    this.sharedRun = !!config.TESTOMATIO_SHARED_RUN;
    this.groupTitle = params.groupTitle || config.TESTOMATIO_RUNGROUP_TITLE;
    this.env = config.TESTOMATIO_ENV;
    ...
    this.proceed = config.TESTOMATIO_PROCEED;
    this.jiraId = config.TESTOMATIO_JIRA_ID;
    this.runId = params.runId || process.env.runId;
    this.createNewTests = params.createNewTests ?? !!config.TESTOMATIO_CREATE;
  ...
  async createRun() {
    ...
    const accessEvent = config.TESTOMATIO_PUBLISH ? 'publish' : null;
