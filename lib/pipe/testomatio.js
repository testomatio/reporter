...
class TestomatioPipe {
  batch = {
    ...
    maxBatchArrSize: 100, // max number of tests in one batch
  }
   ...
   */
  #batchUpload = async () => {
    if (this.batch.tests.length === 0) return;
    ...
    return this.axios
      .post(`/api/reporter/${this.runId}/testrun`, {api_key: this.apiKey,  tests: testsToSend }, {
        maxContentLength: Infinity,
        maxBodyLength: Infinity,
        headers: {
  ...
  addTest(data) {
    ...
    // for cases test is added after run is finished
