...
class GitLabPipe {
  ...
  `;
    ...
    if (this.CI_JOB_NAME && this.CI_JOB_ID) {
      summary += `| Job | 👷 [${this.CI_JOB_ID}](${this.CI_JOB_URL})<br>Name: **${this.CI_JOB_NAME}**<br>Stage: **${this.CI_JOB_STAGE}** | `;
    }
    ...
    try {
      ...
      const commentURL = `${this.CI_PROJECT_URL}/-/merge_requests/${this.CI_MERGE_REQUEST_IID}#note_${JSON.parse(response.body).id}`;
