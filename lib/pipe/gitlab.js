...
async function deletePreviousReport(axios, commentsRequestURL, hiddenCommentData, token) {
  ...
  try {
    const response = await axios.get(`${commentsRequestURL}?access_token=${token}`);
