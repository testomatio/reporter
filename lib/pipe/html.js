...
class HtmlPipe {
  ...
  async finishRun(runParams) {
    ...
    if (this.isHtml) {
      ...
      //TODO: Vitaliy -> need to add try/catch block
      this.buildReport({
        runParams,
  ...
  #loadReportHelpers() {
    ...
    handlebars.registerHelper(
      'select', //TODO: rename, maybe  paginationSelectComponent ???
    ...
    handlebars.registerHelper(
      'noDataBlock', //TODO: rename, maybe  emptyDataComponent ???
      () =>  new handlebars.SafeString(
    ...
    handlebars.registerHelper(
      'pageStructure', //TODO: rename, maybe  xxx ???
      tests => {
