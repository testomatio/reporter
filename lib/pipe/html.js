...
class HtmlPipe {
    ...
    async finishRun(runParams) {
        ...
        if (this.isHtml) {
            ...
            this.buildReport(this.data, this.htmlOutputPath, this.templateHtmlPath, this.filenameMsg);
        }
    }
    /**
     ...
     * @param {string} outputPath - The path where the HTML report will be saved.
     * @param {string} templatePath - The path to the template used for generating the HTML report.
     * @param {string} [warningMsg=""] - An optional warning message displayed during report generation.
     * @returns {void} - This function does not return anything.
     */
    buildReport(data, outputPath, templatePath, warningMsg = "") {
        ...
        if (warningMsg) {
            console.log(chalk.blue(warningMsg));
        }
