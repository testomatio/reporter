...
const prettyMs_1 = __importDefault(require("pretty-ms"));
const { APP_PREFIX } = require("../constants.js");
...
class DebugPipe {
  ...
  logToFile(logData) {
    ...
    const logLine = JSON.stringify({ t: `+${prettyMs_1.default(timePassedFromLastAction)}`, ...logData });
