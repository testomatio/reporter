...
class DataStorage {
   ...
   * @param {'log' | 'artifact' | 'key-value'} dataType – storage type (like 'log', 'artifact'); could be any string, used only to define file path
   * @param {Object} options – isFileStorage (true by default) – defines if data should be stored to file or to global variable
   */
