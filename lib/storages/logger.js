...
class Logger {
  ...
  constructor({ adapter, testId }) {
    this.adapter = adapter;
    this.testId = testId;

    this.#dataStorage = new DataStorage('log', { adapter: this.adapter, testId: this.testId });
  ...
  step(strings, ...values) {
    ...
    this.#dataStorage.putData(logs, this.testId);
  }
  ...
  #logWrapper(argsArray, level) {
    ...
    this.#dataStorage.putData(colorizedLogs, this.testId);
    try {
