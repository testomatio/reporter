...
const { createTmpDir, clearAllTestomatTmpDirs } = require('../artifacts');
...
function MochaReporter(runner, opts) {
  ...
  runner.on(EVENT_RUN_BEGIN, () => {
    ...
    if (runner._workerReporter != undefined) {
      //create tmp folder for all files
  ...
  runner.on(EVENT_TEST_PASS, test => {
    ...
    //TODO: даже если я получу с тмп все файлики и данные, то мне же их нужно будет как то еще и прокинуть в сами тесты, а сейчас обработка идет в методе => addTestRun()
