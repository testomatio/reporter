...
class Logger {
  ...
  intercept(userLogger) {
    ...
    */
    ...
    /*
    Initial idea was to intercept any logger (tracer, pino, etc), intercept message and provide output by the same logger.
    ...
    It means, if user uses his own logger, its messages will be intercepted, but the output will be provided by default console.
