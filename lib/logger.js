...
class Logger {
  ...
  */
   ...
   * When call this method, Logger start to control the user logger, but almost nothing is changed for user ragarding the console output
   * (like log level set by user)
   * (until multiple loggers are intercepted, in this case only the last intercepted logger will be used as user console output).
   * @param {*} userLogger
   */
...
// TODO: in case of unset _originalUserLogger, logger.{method} will not provide console output; need to add some logger by default
