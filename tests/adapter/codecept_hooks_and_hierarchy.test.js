...
describe('CodeceptJS Hooks and Step Hierarchy', function () {
  ...
  async function runCodeceptTest(testFile, extraEnv = {}) {
    ...
    const testEntries = result.debugData.filter(
      entry => entry.action === 'addTestsBatch' || entry.action === 'addTest',
    );
  ...
  describe('Comprehensive Integration', () => {
    ...
    it('should maintain consistency across different test types', async () => {
      ...
      const testFiles = ['hooks_with_steps_test.js', 'hooks_and_sections_test.js', 'steps_sections_test.js'];
